...
export default function ImageMapperPage() {
	const URL = "http://127.0.0.1:8090/api/files/pbc_2648271836/3sepgk4uve104k6/home_img_en752wv0kk.jpg?thumb=1920x1080";
		...
		areas: [
			{
				...
				active: true,
				coords: [
					1154, 782, 1092, 744, 1106, 197, 1066, 192, 1066, 178, 1059, 178, 1059, 162, 1034, 161, 1034, 158, 1018, 158,
					1018, 160, 1012, 160, 1012, 126, 954, 124, 898, 124, 894, 126, 894, 177, 852, 178, 864, 762, 864, 788, 910,
					823, 910, 858, 915, 863, 916, 979, 986, 979, 997, 993, 1150, 941, 1151, 874,
				],
			},
			{
				id: "2",
