...
export type AvailabilitiesResponse<Texpand = unknown> = Required<AvailabilitiesRecord> &
	BaseSystemFields<Texpand>;
...
export type OrganizationMembershipResponse<Texpand = unknown> = Required<OrganizationMembershipRecord> &
	BaseSystemFields<Texpand>;
export type OrganizationsResponse<Texpand = unknown> = Required<OrganizationsRecord> &
	BaseSystemFields<Texpand>;
export type ProjectClientsResponse<Texpand = unknown> = Required<ProjectClientsRecord> &
	BaseSystemFields<Texpand>;
export type ProjectsResponse<Tlocation = unknown, Texpand = unknown> = Required<ProjectsRecord<Tlocation>> &
	BaseSystemFields<Texpand>;
export type StructuresResponse<Tmeta = unknown, Texpand = unknown> = Required<StructuresRecord<Tmeta>> &
	BaseSystemFields<Texpand>;
export type TransitionsResponse<Tmeta = unknown, Texpand = unknown> = Required<TransitionsRecord<Tmeta>> &
	BaseSystemFields<Texpand>;
export type TypologiesResponse<Texpand = unknown> = Required<TypologiesRecord> & BaseSystemFields<Texpand>;
export type TypologyFeaturesResponse<Texpand = unknown> = Required<TypologyFeaturesRecord> &
	BaseSystemFields<Texpand>;
export type UnitFeaturesResponse<Texpand = unknown> = Required<UnitFeaturesRecord> &
	BaseSystemFields<Texpand>;
export type UnitsResponse<Tmeta = unknown, Texpand = unknown> = Required<UnitsRecord<Tmeta>> &
	BaseSystemFields<Texpand>;
